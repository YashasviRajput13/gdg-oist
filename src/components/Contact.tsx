...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding relative overflow-hidden" ref={ref}>
      <div className="absolute top-20 right-10 w-80 h-80 bg-primary/5 animate-blob blur-3xl" />
      <div className="absolute bottom-10 left-10 w-64 h-64 bg-accent/5 animate-blob-reverse blur-3xl" />
