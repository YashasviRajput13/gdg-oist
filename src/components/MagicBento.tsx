...
const cardData: CardItem[] = [
    {
        ...
        description: 'Hands-on sessions on Cloud, Android, and Web.',
        label: 'Learn'
    },
    {
        color: '#060010',
        title: 'Hackathons',
        description: 'Competitive coding and solution building.',
        label: 'Compete'
    },
    {
        color: '#060010',
        title: 'Project Showcases',
        description: 'Demonstrating impactful student-led projects.',
        label: 'Build'
    },
    {
        color: '#060010',
        title: 'Developer Festivals',
        description: 'DevFest and I/O Extended flagship events.',
        label: 'Experience'
    },
    {
        color: '#060010',
        title: 'Community Meetups',
        description: 'Networking and knowledge sharing sessions.',
        label: 'Connect'
    },
    {
        color: '#060010',
        title: 'Expert Talks',
        description: 'Insights from industry professionals and GDEs.',
        label: 'Insights'
    }
];
        ...
        <>
            ...
            <BentoCardGrid gridRef={gridRef}>
                {cardData.map((card, index) => {
                    ...
                    // Define custom CSS properties with proper casting for TypeScript
                    const cardStyle = {
